...
REFRESH_PROGRESS_DB_UPDATE_INTERVAL_TICKERS = int(
    os.getenv("REFRESH_PROGRESS_DB_UPDATE_INTERVAL_TICKERS", "5").strip() or "5"
)
REFRESH_PROGRESS_CALLBACK_INTERVAL_TICKERS = int(
    os.getenv("REFRESH_PROGRESS_CALLBACK_INTERVAL_TICKERS", "5").strip() or "5"
)
HISTORICAL_APPEND_PROGRESS_DB_UPDATE_INTERVAL_TICKERS = int(
    os.getenv("HISTORICAL_APPEND_PROGRESS_DB_UPDATE_INTERVAL_TICKERS", "5").strip() or "5"
)

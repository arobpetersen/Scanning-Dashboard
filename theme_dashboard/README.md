...
- **Active themes** (default): full active ticker universe
- **Selected theme**: tickers from a single theme
- **Custom ticker list**: manual ticker subset

Large full-universe live refreshes can be slow due to API calls. Prefer scoped refresh for day-to-day live usage.
